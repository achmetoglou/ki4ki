...
_DECKBLATT_ANWEISUNG = (
    ...
    "Empfaenger. Der Empfaenger steht im Anschriftenfeld oben, oft als "
    "groesster Block und haeufig als EINZIGE Firma im Text - er ist es "
    "trotzdem NICHT. "
    "WICHTIG: Der Absender steht sehr oft NIRGENDWO im Text. Geschaeftsbriefe "
    "werden auf vorgedrucktem Briefbogen geschrieben; Briefkopf und Fusszeile "
    "sind Teil des Papiers und fehlen in der Datei. Schliesse daraus NICHT, "
    "die einzige genannte Firma sei der Verfasser - sie ist dann der "
    "Empfaenger. "
    "Woran du den Absender trotzdem erkennst, in dieser Reihenfolge: "
    "(1) \'Unsere Auftragsnummer\' / \'unser Zeichen\' gehoert dem ABSENDER, "
    "\'Ihre Bestellnummer\' / \'Ihr Zeichen\' dem Empfaenger; "
    "(2) die Zeile \'Sachbearbeiter\' mit Name und Telefon gehoert dem "
    "ABSENDER - der Empfaenger nennt seine Durchwahl nicht; "
    "(3) wer eine Rechnung stellt oder ein Angebot macht, ist der Absender; "
    "wer bestellt hat, der Empfaenger; "
    "(4) nur falls vorhanden: Briefkopf oder Fusszeile mit Bankverbindung, "
    "Registergericht, Steuernummer. "
    "Ergibt sich daraus nur ein NAME einer Person (Sachbearbeiter) und keine "
    "Organisation, nimm die Person. Bleibt der Absender unklar, lass den "
    "Verfasser LEER - lieber leer als falsch. Setze NIE die Firma aus dem "
    "Anschriftenfeld als Verfasser ein. "
    "\n"
