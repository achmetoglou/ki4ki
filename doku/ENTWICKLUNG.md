...
|---|---|---|
| `python3 pruef-proxy/dialogtest.py` | 38 Szenarien, 424 Prüfungen ohne Modell: Router, Faden, Prüfungskatalog, Rolle, Kategorien, Rechte je Ausgabeweg, Aufnahme-Übersicht | vor jedem Push |
