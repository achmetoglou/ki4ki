...
|---|---|---|
| `python3 pruef-proxy/dialogtest.py` | 37 Szenarien, 417 Prüfungen ohne Modell: Router, Faden, Prüfungskatalog, Rolle, Kategorien, Rechte je Ausgabeweg, Aufnahme-Übersicht | vor jedem Push |
