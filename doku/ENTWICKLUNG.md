...
|---|---|---|
| `python3 pruef-proxy/dialogtest.py` | 39 Szenarien, 435 Prüfungen ohne Modell: Router, Faden, Prüfungskatalog, Rolle, Kategorien, Rechte je Ausgabeweg, Aufnahme-Übersicht | vor jedem Push |
